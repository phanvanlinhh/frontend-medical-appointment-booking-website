...
class UserRedux extends Component {
    ...
    handleSaveUser = () => {
        ...
        //console.log("Current state values:", this.state.gender, this.state.position, this.state.role);
        ...
        if (action === manageActions.EDIT) {
            let isValidEdit = this.checkValidateInputEdit();
            if (isValidEdit === false) return;
    ...
    checkValidateInputEdit = () => {
        ...
        let arrCheckEdit = ['email', 'firstName', 'lastName', 'phoneNumber', 'address']
        for (let i = 0; i < arrCheckEdit.length; i++) {
            if (!this.state[arrCheckEdit[i]]) {
                isValidEdit = false;
                alert('This input is required: ' + arrCheckEdit[i])
                break;
            }
        }
        return isValidEdit;
                ...
                <div className="user-redux-body" >
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-12 my-3'>
                                <button className={this.state.action === manageActions.EDIT ? 'btn btn-warning' : 'btn btn-primary'}
